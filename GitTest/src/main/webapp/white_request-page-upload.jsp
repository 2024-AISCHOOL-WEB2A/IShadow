...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/white_request-page-upload.css" />
    ...
    <div class="container-center-horizontal">
      <div class="request-page-upload screen">
        <div class="overlap-group3">
          <h1 class="text-1 text">해줘요</h1>
          <div class="overlap-group2">
            <img class="rectangle-356" src="assets/img/rectangle-356.svg" alt="Rectangle 356" />
