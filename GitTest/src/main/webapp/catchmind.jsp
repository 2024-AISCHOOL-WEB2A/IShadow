...
#canvasOutput {
    ...
    z-index: 9999;       /* 높은 값을 주어 맨 앞에 위치하도록 함 */
}
</style>
</head>
			...
			<div class="input-container">
				<form action="InsertRanking" method="post" id="rankingForm">
					...
					<input type="text" placeholder="닉네임을 입력하세요" name="nickName"
						class="input-field" onblur="hideInput()" required> <input
						type="hidden" id="hidden-time" name="hiddenTime"> <input
