...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/white_request-page.css" />
    ...
    <style>
        ...
        body {
            ...
            margin: 0;
            background: url('assets/img/white_background.png') no-repeat center center fixed;
        ...
        .rectangle-355 {
            ...
            margin-top: 114px !important; /* 위쪽 여백 추가 */
    ...
    <script type="text/javascript">
        function redirectToUpload() {
            window.location.href = 'white_request-page-upload.jsp';
        }
    </script>
</head>
<body>
