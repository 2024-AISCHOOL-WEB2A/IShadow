...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/catchmind-result.css" />
    <link rel="stylesheet" type="text/css" href="assets/css/styleguide.css" />
    <link rel="stylesheet" type="text/css" href="assets/css/globals.css" />
  </head>
  <body style="margin: 0; background: #000000">
    <input type="hidden" id="anPageName" name="page" value="catchmind-result" />
          ...
          <div class="overlap-group-1">
            ...
            <div class="group-2613110">
              ...
              <div class="text-container single-linebody-base">
                ...
                <div class="text-44 valign-text-middle">캐치마인드</div>
                <div class="text-45 valign-text-middle">공유하기</div>
              </div>
            </div>
          </div>
