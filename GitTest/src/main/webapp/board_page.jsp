...
<body style="margin: 0; background: #000000">
	<div class="desktop-1">
		...
		<div class="overlap-group4">
			...
			<h1 class="text-55" style="margin-bottom: 0px; margin-top: 99px;">커뮤니티</h1>
					...
					<div class="group-2613103-item board">
						<div class="link">
							<div class="overlap-group"
								style="background-image: url(<%=posts.get(i).getFile()%>);"
								onclick="testclick();"></div>
						</div>
		...
		<div>
			...
			<div style="text-align: center; color: white;"><%=myPage%></div>
