...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/choice-1-or-2.css" />
    <link rel="stylesheet" type="text/css" href="assets/css/styleguide.css" />
    <link rel="stylesheet" type="text/css" href="assetscss/globals.css" />
  </head>
          ...
          <div class="overlap-group">
            ...
            <div class="group-2613110">
              ...
              <div class="text-container single-linebody-base">
                ...
                <div class="text-109 valign-text-middle">캐치마인드</div>
                <div class="text-110 valign-text-middle">공유하기</div>
              </div>
            </div>
          </div>
        </div>
