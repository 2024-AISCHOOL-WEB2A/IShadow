      ...
      <div class="catchmind-ranking screen">
        <div class="overlap-group4">
          ...
          <div class="overlap-group3 inter-normal-white-55px">
            <div class="x5th">
              <div class="x5th-1">5th</div>
              <div class="text-7">05 : 00</div>
              <div class="scrates">Sócrates</div>
            </div>
            <div class="x4th">
              <div class="x4th-1">4th</div>
              <div class="text">04 : 00</div>
              <div class="crow">Crow</div>
            </div>
            <div class="x3rd">
              <div class="x3rd-1">3rd</div>
              <div class="text">03 : 00</div>
              <div class="naile">Naile</div>
            </div>
            <div class="x2nd">
              <div class="x2nd-1">2nd</div>
              <div class="text-10">02 : 00</div>
              <div class="c-h-w">C H W</div>
            </div>
            <div class="x1st inter-normal-white-55px">
              <div class="x1st-1">1st</div>
              <div class="text-11">01 : 00</div>
              <div class="k-d-y">K D Y</div>
            </div>
