    ...
    <div class="container-center-horizontal">
        <div class="catchmindu95ranking screen">
            <div class="overlap-group3">
                <img class="create-a-high-resolu" src="assets/img/white_background.png" alt="background" />
                ...
                <div class="overlap-group" onclick="moveMain()">
                    <img class="image" src="assets/img/catchmind_ranking/white_gohome.png" alt="image" />
                    <div class="view view-2"></div>
                    <div class="gText">처음으로</div>
                </div>
                <div class="overlap-group1" onclick="reTry()">
                    <img class="image-1" src="assets/img/catchmind_ranking/white_replay.png" alt="image" />
