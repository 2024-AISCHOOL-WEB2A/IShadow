 ...
 */
// 게시물 상세 보기
@WebServlet("/WhitePostsCommentAll")
public class WhitePostsCommentAll extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("white_board-inpage.jsp");
